...
function PciCd(){
    ...
    const sectionTitles = [
        ...
        "Description - Tag Namespace / Cost Tracking",
        "Description - Events & Alarms Setup",
        "Description - Audit Logs / VCN Flow Logs",
  ...
  const isLastSection = currentSectionIndex === sectionTitles.length - 1;
    ...
    <div className="container">
        <h2 className="title">TYPE - CI/CD</h2>
